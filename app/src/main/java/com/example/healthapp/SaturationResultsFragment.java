...
public class SaturationResultsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        currentView = inflater.inflate(R.layout.fragment_saturation_results, container, false);
        return currentView;
    }
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        listView = view.findViewById(R.id.saturationListview);
        lastResult = view.findViewById(R.id.lastSaturationResult);
        meanResults = view.findViewById(R.id.meanSaturationResults);
        resetChartButton = view.findViewById(R.id.saturationResetChartButton);
        previousListViewResultsButton = view.findViewById(R.id.previousSaturationResults);
        nextListViewResultsButton = view.findViewById(R.id.nextSaturationResults);
        listViewResultsInfo = view.findViewById(R.id.saturationListviewText);
        chartLeftButton = view.findViewById(R.id.saturationChartLeft);
        chartRightButton = view.findViewById(R.id.saturationChartRight);
        chart = (LineChart) view.findViewById(R.id.saturationChart);
    ...
    private void getData(){
        ...
        for(BloodPressureResult bloodPressureResult : last7DaysBloodPressureResultsArrayList){
            chartArrayList.add(new Entry(i, (float) bloodPressureResult.getSaturation()));
            i += 1;
        }
    }
