...
public class PulseResultsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        currentView = inflater.inflate(R.layout.fragment_pulse_results, container, false);
        return currentView;
    }
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        listView = view.findViewById(R.id.pulseListview);
        lastResult = view.findViewById(R.id.lastPulseResult);
        meanResults = view.findViewById(R.id.meanPulseResults);
        resetChartButton = view.findViewById(R.id.pulseResetChartButton);
        previousListViewResultsButton = view.findViewById(R.id.previousPulseResults);
        nextListViewResultsButton = view.findViewById(R.id.nextPulseResults);
        listViewResultsInfo = view.findViewById(R.id.pulseListviewText);
        chartLeftButton = view.findViewById(R.id.pulseChartLeft);
        chartRightButton = view.findViewById(R.id.pulseChartRight);
        chart = (LineChart) view.findViewById(R.id.pulseChart);
    ...
    private void getData(){
        ...
        for(BloodPressureResult bloodPressureResult : last7DaysBloodPressureResultsArrayList){
            chartArrayList.add(new Entry(i, (float) bloodPressureResult.getPulse()));
            i += 1;
        }
    }
